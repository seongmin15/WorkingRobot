...
public class roomService {
    ...
    @Scheduled(cron = "0 50 8-20 * * *", zone = "Asia/Seoul")
    public void putOrderInResTblOn()
    {
        ...
        for (Optional<roomResEntity> roomRes : roomResList) {
            ...
            // 회의실세팅 시작 알람
            AlarmService.save(roomRes.get().getUserId(), "office", true, roomStatus.get().getRoomName());
        }
    }

    @Scheduled(cron = "0 10 9-21 * * *", zone = "Asia/Seoul")
